...
namespace CDb.Transversal.Utilitarios
{
    ...
    public abstract class DynamicClass
    {
        ...
        public string ObtenerValorIdentificador()
        {
            PropertyInfo[] props = this.GetType().GetProperties(BindingFlags.Instance | BindingFlags.Public);
            StringBuilder sb = new StringBuilder();
            ...
            if (props.Length > 1)
            {
                var val1 = props[1].GetValue(this, null);

                if (props.Length >= 3)
                {
                    var val2 = props[2].GetValue(this, null);
...
#pragma warning restore 0219
        ...
        MemberInfo FindPropertyOrField(Type type, string memberName, bool staticAccess)
        {
            ...
            {
                //Cambio de Denis. Estaba buscando con Type.FilterNameIgnoreCase
                //E ignoraba las propiedades que empezaban en minuscula
