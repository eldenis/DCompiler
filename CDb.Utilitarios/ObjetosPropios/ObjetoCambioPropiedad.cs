...
{
    /// <summary>
    /// Una clase que implementa a INotifyPropertyChanged exponiendo métodos
    /// de uso simple para utilizar en toda la solución
    /// </summary>
    public abstract class ObjetoCambioPropiedad : IPropiedadCambioConEvento
    {
