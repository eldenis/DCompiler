...
using Infraestructura.Transversal.Utilitarios;
using System.Windows.Controls;
using System.Reflection;
using System.Threading;
using System.Resources;
using System.Globalization;
using Infraestructura.Transversal.Configuracion;
...
namespace WPF.Cliente.Util
{
    public class EnumsWPF : IValueConverter
    {
        ...
        static EnumsWPF()
        {
            WPF.General.Enums.Culture = new CultureInfo(Configuracion.Generales.Cultura);
        }

        static Dictionary<Type, Dictionary<string, string>> dicEnums =
            new Dictionary<Type, Dictionary<string, string>>();

        static readonly Type RecursoPredeterminado = typeof(WPF.General.Enums);
